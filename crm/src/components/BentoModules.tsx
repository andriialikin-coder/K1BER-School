              ...
              <div key={idx} className="flex flex-col md:flex-row gap-4 p-5 rounded-2xl bg-slate-800/40 border border-white/5 hover:bg-slate-800/60 transition-colors">
                ...
                <div className="md:w-1/3 shrink-0 bg-slate-950/50 p-4 rounded-xl border border-slate-800/50 flex flex-col justify-center">
                  ...
                  <button 
                    ...
                    className="mt-4 w-full inline-flex items-center justify-center gap-2 text-[14px] font-bold text-white py-3 px-4 rounded-xl bg-orange-500 hover:bg-orange-600 shadow-[0_0_15px_rgba(249,115,22,0.4)] hover:shadow-[0_0_20px_rgba(249,115,22,0.6)] transition-all tracking-wide"
                  >
                    Забронювати місце
                  </button>
                </div>
