...
const STATUS_OPTIONS = [
  ...
  },
  {
    ...
    label: 'Коллбєк',
    icon: PhoneCall,
    badge: 'bg-violet-50 text-violet-700 ring-1 ring-violet-500/20',
    dot: 'bg-violet-500',
  },
  {
    value: 'Не відповідає',
    label: 'Не відповідає',
    icon: PhoneMissed,
    badge: 'bg-orange-50 text-orange-700 ring-1 ring-orange-500/20',
    dot: 'bg-orange-400',
  },
  {
    value: 'Запрошений',
  ...
  },
  {
    ...
    label: 'Не цікаво',
    icon: XCircle,
    badge: 'bg-rose-50 text-rose-700 ring-1 ring-rose-500/20',
    dot: 'bg-rose-400',
  },
  {
    value: 'Архів',
    label: 'Архів',
    icon: Archive,
    badge: 'bg-slate-100 text-slate-500 ring-1 ring-slate-400/20',
    dot: 'bg-slate-400',
  },
];

// Legacy DB values → display config
  ...
  return (
    <div className="relative inline-flex items-center">
      <select
        ...
        "
      >
        {/* Show legacy value as placeholder if current status is legacy */}
      ...
      <footer className="bg-white border-t border-slate-100 py-4 mt-auto">
        <div className="max-w-screen-xl mx-auto px-6 flex flex-col sm:flex-row items-center justify-between gap-2">
          <p className="text-xs text-slate-400">
            © {new Date().getFullYear()} Kiber School CRM&nbsp;&nbsp;·&nbsp;&nbsp;v1.0.0
          </p>
