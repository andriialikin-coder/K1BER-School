...
3. Шукай БІЛЬ у розгорнутих питаннях FAQ (opened_faq), обраних курсах (viewed_courses) та змінах вибору у формі (course_selection_history). Якщо людина читала FAQ про ноутбук - зніми цей страх! Якщо обирала між двома курсами - запропонуй допомогу у виборі.
