          ...
          >
            ...
            {(feature as any).image && (
              <div className="mt-auto pt-10 relative w-full flex justify-center pointer-events-none">
                 <img src={(feature as any).image} alt={feature.title} className="w-[50%] md:w-[60%] lg:w-[90%] object-contain group-hover:scale-105 group-hover:-translate-y-2 transition-all duration-500 ease-out z-0 md:-translate-y-4" />
              </div>
            )}
          </div>
        ))}
