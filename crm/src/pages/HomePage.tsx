...
export default function HomePage() {
  ...
  return (
    <main className="w-full bg-slate-950 overflow-x-hidden">
      <section className="relative w-full min-h-[calc(100vh-72px)] flex flex-col items-center justify-start pt-12 sm:pt-24 lg:justify-center lg:pt-0 pb-12 sm:pb-20 px-4 sm:px-6 overflow-hidden">
      ...
      <div className="hidden sm:block absolute top-[12%] right-[5%] md:right-[15%] z-10 animate-float-slow pointer-events-none blur-[0.5px] opacity-60 sm:opacity-80">
        <svg viewBox="0 0 100 100" className="w-16 h-16 sm:w-28 sm:h-28 md:w-36 md:h-36 text-cyan-400 drop-shadow-[0_0_20px_rgba(6,182,212,0.4)]">
          <defs>
      ...
      {/* VR-Очки (слева внизу) */}
      <div className="hidden sm:block absolute bottom-[10%] left-[3%] md:left-[12%] z-10 animate-float-medium pointer-events-none blur-[0.8px] opacity-75">
      ...
      {/* Цифровые глифы */}
      {/* Атом слева вверху */}
      <div className="hidden sm:block absolute top-[18%] left-[6%] md:left-[16%] z-0 animate-float-fast opacity-50 pointer-events-none">
      ...
      <div className="hidden sm:block absolute top-[52%] right-[5%] md:right-[10%] z-0 animate-float-medium opacity-45 pointer-events-none">
      ...
      <div className="hidden sm:block absolute top-[50%] left-[4%] md:left-[10%] z-0 animate-float-slow opacity-45 pointer-events-none">
      ...
      <div className="hidden sm:block absolute bottom-[20%] right-[3%] md:right-[12%] z-0 animate-float-fast opacity-40 pointer-events-none">
      ...
      <div className="relative max-w-4xl z-20 flex flex-col items-center text-center">
        ...
        <h1 
          className="text-4xl sm:text-7xl md:text-8xl lg:text-[5.5rem] font-black tracking-tight leading-[1.05] mb-2 text-white"
        ...
        <p className="text-slate-400 text-sm sm:text-xl md:text-2xl mt-4 max-w-2xl mx-auto leading-relaxed font-medium mb-6 sm:mb-8 px-2 sm:px-0">
      ...
      {/* Статистика / Факты */}
      <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 mt-6 sm:mt-8 md:mt-16 z-20 relative flex flex-row items-center justify-center gap-3 sm:gap-8 md:gap-16">
